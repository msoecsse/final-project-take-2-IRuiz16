...
public class GameProxy {
    ...
    /**
     * Pops up first so player can make choice of whether they are x or o for the game
     */
    protected void popUp(){
        ...
        Optional<String> choice = popup.showAndWait();

        choice.ifPresent(s -> playerChoice = s);
